...
- list models
- map dbt run over models
- map dbt test over models (after runs)
- pool limits concurrency for both stages
"""
...
def demo_dbt_snowflake_map_run_test():
    ...
    dbt_run = (
        ...
        .partial(
            ...
            # pool: a global concurrency limiter. 
            # If you don't set this, all dbt tasks will run at once.
            pool="snowflake_pool",
    ...
    dbt_test >> final_report()

demo_dbt_snowflake_map_run_test()
